...
public abstract class ActionMode {
     ...
     * will have its {@link android.support.v7.view.ActionMode.Callback#onPrepareActionMode(android.support.v7.view.ActionMode, Menu)} method called. If it
     ...
     *
     * <li>{@link android.support.v7.view.ActionMode.Callback#onPrepareActionMode(android.support.v7.view.ActionMode, Menu)}
     * after creation and any time the {@link android.support.v7.view.ActionMode} is invalidated</li>
     *
     * <li>{@link
     * android.support.v7.view.ActionMode.Callback#onActionItemClicked(android.support.v7.view.ActionMode, MenuItem)} any time a contextual action button is
     * clicked</li>
     *
